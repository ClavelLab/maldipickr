...
- [SPeDE](https://github.com/LM-UGent/SPeDE) is a Python/R based tool
  with good dereplication performance that creates OTU-like clusters of
  MALDI spectra.
- [IDBac](https://idbac.org/) is an online tool for dereplication and
  identification that can include analysis of secondary metabolite
  production provided you have the data.
