...
However, when the Bruker MALDI Biotyper device produces `acqus` files (instead of the native `acqu` files), the `readBrukerFlexDir()` function from the [`readBrukerFlexData`](https://cran.r-project.org/package=readBrukerFlexData) package
