...
# Target factory to pick representative spectra from clusters of MALDI-TOF spectra
    
```{r function-tar_pick_with_similarity}
...
```{r example-tar_pick_with_similarity, eval=FALSE}
tar_pick_with_similarity()
```
  
```{r tests-tar_pick_with_similarity}
