...
#' 
#' # TODO: add link to [targets::tar_target]
#' 
...
#' @inheritParams targets::tar_target_raw # TODO: add others parameters to inherit
#'
...
#' `*_plates_files` (e.g., `anaerobe_plates_files`): 
#' `*_plates` (e.g., `anaerobe_plates`): 
#' `*_spectra_raw` (e.g., `anaerobe_spectra_raw`): 
#' `*_checks` (e.g., `anaerobe_checks`): 
#' `*_valid_spectra` (e.g., `anaerobe_valid_spectra`): 
#' `*_spectra_stats` (e.g., `anaerobe_spectra_stats`): 
#' `*_processed` (e.g., `anaerobe_processed`): 
#' 
