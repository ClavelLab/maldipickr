...
# Ran once after issue with pkgs moved from Suggests to Imports
attachment::att_amend_desc(extra.suggests = c("targets","tarchetypes", "coop"),pkg_ignore = c("targets","tarchetypes", "coop"), normalize = TRUE, update.config = TRUE)
...
usethis::use_import_from("rlang", ".data","check_installed")
usethis::use_import_from(
  "MALDIquant",
  c(
...
# See attachment::att_amend_desc above, because fusen moves the confi below to Imports during inflate
usethis::use_package("targets", type = "Suggests", min_version = "1.7.0")
usethis::use_package("tarchetypes", type = "Suggests", min_version = "0.9.0")
```
